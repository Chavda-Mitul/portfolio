...
const FEATURED = [
    { user: 'Mitul Chavdas', name: 'BranchGPT' },
    { user: 'Mitul Chavdas', name: 'Vaani' },
    { user: 'Mitul Chavdas', name: 'Odeon' },
    { user: 'Mitul Chavdas', name: 'MapMyRepo' },
    { user: 'Mitul Chavdas', name: 'PolySEE' },
];
