...
export const projects = [
  {
    ...
    url: 'https://github.com/Mitul Chavdas/JustHireMe',
  ...
  },
  {
    ...
    url: 'https://github.com/Mitul Chavdas/Svara',
  ...
  },
  {
    ...
    url: 'https://github.com/Mitul Chavdas/Odeon', demo: 'https://www.youtube.com/watch?v=GFdSe4-c_xQ',
  ...
  },
  {
    ...
    url: 'https://github.com/Mitul Chavdas/Waldo',
  ...
  },
  {
    ...
    url: 'https://github.com/Mitul Chavdas/Socratis',
  ...
  },
  {
    ...
    url: 'https://github.com/Mitul Chavdas/Forge',
  ...
  { slug: 'vaani', name: 'Vaani', group: 'earlier', kind: 'Public source · Voice agent', status: 'Prototype with demo video',
    ...
    url: 'https://github.com/Mitul Chavdas/Vaani', demo: 'https://www.youtube.com/watch?v=VsEfOfwh8XM', tech: ['LiveKit', 'Deepgram', 'Groq', 'FastAPI', 'React'] },
  {
    ...
    url: 'https://github.com/Mitul Chavdas/BranchGPT', demo: 'https://www.youtube.com/watch?v=RB3zvAXbpL0',
  ...
  { slug: 'mapmyrepo', name: 'MapMyRepo', group: 'earlier', kind: 'Public source · Dev tool', status: 'Public repository',
    ...
    url: 'https://github.com/Mitul Chavdas/MapMyRepo', demo: 'https://www.youtube.com/watch?v=EmTDrPzAo40', tech: ['D3', 'Gemini', 'React'] },
  { slug: 'leetbot', name: 'LeetBot', group: 'earlier', kind: 'Public source · Browser extension', status: 'Public repository',
    ...
    url: 'https://github.com/Mitul Chavdas/LeetBot', tech: ['Browser extension', 'Mermaid'] },
  { slug: 'sss', name: 'SSS', group: 'earlier', kind: 'Public source · Local vision', status: 'Public repository',
    ...
    url: 'https://github.com/Mitul Chavdas/SSS', tech: ['Python', 'PyTorch', 'Qwen2-VL'] },
  ...
  { slug: 'asciirealtime', name: 'ASCIIRealTime', group: 'play', kind: 'Public source · Webcam toy', status: 'Public repository',
    ...
    url: 'https://github.com/Mitul Chavdas/ASCIIRealTime', tech: ['JavaScript', 'MediaPipe'] },
  { slug: 'pixelforge', name: 'PixelForge', group: 'play', kind: 'Public source · Desktop tool', status: 'Public repository',
    ...
    url: 'https://github.com/Mitul Chavdas/PixelForge', tech: ['Java 17', 'JavaFX'] },
  { slug: 'gitart', name: 'GitArt', group: 'play', kind: 'Public source · Browser tool', status: 'Public repository',
    ...
    url: 'https://github.com/Mitul Chavdas/GitArt', tech: ['Next.js', 'isomorphic-git', 'JSZip'] },
  { slug: 'habiturtle', name: 'habiTurtle', group: 'play', kind: 'Public source · Desktop app', status: 'Public repository',
    ...
    url: 'https://github.com/Mitul Chavdas/habiTurtle', tech: ['Python', 'PyQt'] },
  { slug: 'maze-pathfinder', name: 'Maze Pathfinder Visualizer', group: 'play', kind: 'Public source · Visualizer', status: 'Public repository',
    ...
    url: 'https://github.com/Mitul Chavdas/Maze-Pathfinder-Visualizer', tech: ['Python', 'Pygame'] },
  { slug: 'holeemall', name: 'HoleEmAll', group: 'play', kind: 'Public source · Arcade game', status: 'Public repository',
    ...
    url: 'https://github.com/Mitul Chavdas/HoleEmAll', tech: ['Python', 'Pygame'] }
];
...
export const techIcons = {
  ...
  'FastAPI':'fastapi','Node.js':'nodejs','Express':'express','PostgreSQL':'postgresql','Neon Postgres':'postgresql','SQLite':'sqlite','MongoDB':'mongodb','Supabase':'supabase','Drizzle ORM':['sic','siDrizzle'],'Qdrant':['sic','siQdrant'],'WebSockets':'socketio','HTTPX':'python','Pydantic':['sic','siPydantic'],
  'PyTorch':'pytorch','ONNX embeddings':['sic','siOnnx'],'Ollama':['si','SiOllama'],'LangGraph':['sic','siLanggraph'],'Gemini':['sic','siGooglegemini'],'Groq':['img','/test/logos/groq.png'],'Deepgram':['sic','siDeepgram'],'LiveKit':['sic','siLivekit'],'faster-whisper':['si','SiOpenai'],'CTranslate2':['si','SiOpenai'],'Qwen2-VL':['si','SiAlibabacloud'],'Docling':['file','docling.svg'],'MediaPipe':['si','SiGoogle'],'Vercel AI SDK':['si','SiVercel'],'Claude Code plugin':['si','SiAnthropic'],'Mermaid':['si','SiMermaid'],
  ...
  'Tailwind':'tailwindcss','Vite':'vitejs','Redis':'redis','OpenAI':['si','SiOpenai'],'Anthropic':['si','SiAnthropic'],'Hugging Face':['sic','siHuggingface'],'GitHub Actions':'githubactions','Vercel':['si','SiVercel'],'AWS':'amazonwebservices','Git':'git','WebRTC':['si','SiWebrtc'],'Playwright':'playwright'
};
